...
await timeAlgParsing(1);
await timeAlgParsing(10);
await timeAlgParsing(100);
await timeAlgParsing(1_000);
await timeAlgParsing(10_000);
await timeAlgParsing(100_000);
