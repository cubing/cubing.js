...
// src/cubing/twisty/worker-inside.ts
__markAsModule(exports);
__export(exports, {
  workerInside: () => workerInside
});

// dist/esm/chunk-UJ4KPAG6.js
      ...
      while (__privateGet(this, _idx) < __privateGet(this, _input).length) {
        ...
        if (this.tryConsumeNext(" ")) {
          ...
          while (this.tryConsumeNext(".")) {
            algBuilder.push(addCharIndices(new Pause(), __privateGet(this, _idx) - 1, __privateGet(this, _idx)));
          }
          crowded = true;
          algEndIdx = __privateGet(this, _idx);
          continue mainLoop;
...
var _Move = class extends AlgCommon {
  constructor(...args) {
    super();
    _quantumWithAmount.set(this, void 0);
    var _a;
...
var _Grouping = class extends AlgCommon {
  constructor(algSource, amount) {
    super();
    _quantumWithAmount2.set(this, void 0);
