...
import {Move as Move2, QuantumMove as QuantumMove2} from "cubing/alg";
...
var NxNxNCubeMapper = class {
  ...
  notationToInternal(move) {
    ...
    if (!move.innerLayer && !move.outerLayer) {
      ...
      if ((this.slices & 1) === 1) {
        if (grip === "E") {
          move = new Move(new QuantumMove("D", (this.slices + 1) / 2), move.effectiveAmount);
        } else if (grip === "M") {
          move = new Move(new QuantumMove("L", (this.slices + 1) / 2), move.effectiveAmount);
        } else if (grip === "S") {
          move = new Move(new QuantumMove("F", (this.slices + 1) / 2), move.effectiveAmount);
        }
      }
      if (this.slices > 2) {
        if (grip === "e") {
...
var FaceRenamingMapper = class {
  ...
  convert(move, a, b) {
    ...
    if (grip === ngrip) {
      ...
      return new Move(new QuantumMove(ngrip, move.innerLayer, move.outerLayer), move.effectiveAmount);
    }
  }
  notationToInternal(move) {
...
var MegaminxScramblingNotationMapper = class {
  ...
  notationToExternal(move) {
    if (move.family === "Uv") {
      return new Move(new QuantumMove("y", move.innerLayer, move.outerLayer), move.effectiveAmount);
    }
    if (move.family === "Dv") {
      return negate("y", move.effectiveAmount);
    }
...
var SkewbNotationMapper = class {
  ...
  notationToInternal(move) {
    ...
    if (move.family === "F") {
      return new Move(new QuantumMove("DFR", move.outerLayer, move.innerLayer), move.effectiveAmount);
    } else if (move.family === "R") {
      return new Move(new QuantumMove("DBR", move.outerLayer, move.innerLayer), move.effectiveAmount);
    } else if (move.family === "L") {
      return new Move(new QuantumMove("DFL", move.outerLayer, move.innerLayer), move.effectiveAmount);
    } else if (move.family === "B") {
      return new Move(new QuantumMove("DBL", move.outerLayer, move.innerLayer), move.effectiveAmount);
    } else {
      return null;
    }
  }
  notationToExternal(move) {
    if (this.child.spinmatch(move.family, "DFR")) {
      return new Move(new QuantumMove("F", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else if (this.child.spinmatch(move.family, "DRB")) {
      return new Move(new QuantumMove("R", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else if (this.child.spinmatch(move.family, "DFL")) {
      return new Move(new QuantumMove("L", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else if (this.child.spinmatch(move.family, "DBL")) {
      return new Move(new QuantumMove("B", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else {
      return null;
    }
  }
...
var PyraminxNotationMapper = class {
  ...
  notationToInternal(move) {
    ...
    if (move.family === "U") {
      return new Move(new QuantumMove("flr", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else if (move.family === "R") {
      return new Move(new QuantumMove("fld", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else if (move.family === "L") {
      return new Move(new QuantumMove("frd", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else if (move.family === "B") {
      return new Move(new QuantumMove("dlr", move.innerLayer, move.outerLayer), move.effectiveAmount);
  ...
  notationToExternal(move) {
    if (move.family === move.family.toLowerCase()) {
      ...
      if (this.child.spinmatch(fam, "FLR")) {
        return new Move(new QuantumMove("U", move.innerLayer, move.outerLayer), move.effectiveAmount);
...
var FTONotationMapper = class {
  ...
  notationToInternal(move) {
    if (move.family === "T" && move.innerLayer === void 0 && move.outerLayer === void 0) {
      return new Move(new QuantumMove("FLRv", move.innerLayer, move.outerLayer), move.effectiveAmount);
    } else {
  ...
  notationToExternal(move) {
    ...
    if (this.sw.spinmatch(fam, "FLUR")) {
      return new Move(new QuantumMove("T", move.innerLayer, move.outerLayer), move.effectiveAmount);
    }
    return this.child.notationToExternal(move);
  }
};
...
var PuzzleGeometry = class {
  ...
  stringToBlockMove(mv) {
    ...
    return new Move2(new QuantumMove2(grip, hislice, loslice), amount);
  }
  parseMove(move) {
