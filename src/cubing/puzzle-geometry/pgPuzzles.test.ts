...
const expectedData: { [name: string]: string | null } = {
  "2x2x2": slow("2x2x2, 6, 4, 8, 1, 6, 12"),
  "3x3x3": "3x3x3, 6, 9, 26, 3, 9, 120",
  "4x4x4": slow("4x4x4, 6, 16, 56, 3, 12, 420"),
  "5x5x5": slow("5x5x5, 6, 25, 98, 6, 15, 840"),
  "6x6x6": slow("6x6x6, 6, 36, 152, 7, 18, 420"),
  "7x7x7": slow("7x7x7, 6, 49, 218, 11, 21, 840"),
  ...
  "royal tetraminx": slow("royal tetraminx, 4, 33, 82, 8, 20, 1320"),
  "emperor pyraminx": slow("emperor pyraminx, 4, 49, 126, 13, 28, 1386"),
  "emperor tetraminx": slow("emperor tetraminx, 4, 46, 122, 12, 24, 9240"),
  ...
  gigaminx: slow("gigaminx, 12, 31, 242, 6, 30, 18181800"),
  ...
  "radio chop": slow("radio chop, 20, 10, 92, 3, 20, 41580"),
