...
export const cube2x2x2: PuzzleLoader = {
  ...
  svg: async () => (await import("../dynamic/side-events/puzzles-dynamic-side-events")).cube2x2x2SVG,
  llSVG: getCached(async () => (
    await import("../dynamic/side-events/puzzles-dynamic-side-events")).cube2x2x2LLSVG
  ),
  pg: getCached(async () => {
